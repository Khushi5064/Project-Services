...
%>
                ...
                <div class="navbar-nav m-auto py-0">
					...
					<div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            ...
                            <a href="seller-chng-passwd.jsp" class="dropdown-item">Change Password</a>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Seller's Profile</h1>
            <div class="d-inline-flex align-items-center text-white">
                    ...
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        ...
                        <input type="hidden" name="id" value="<%=s.getId() %>">
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="name" name="name" value=<%=s.getName() %>
                                    required="required" data-validation-required-message="Please enter your name" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="contact" name="contact" value=<%=s.getContact() %>
                                    required="required" data-validation-required-message="Please enter your contact" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="address" name="address" value=<%=s.getAddress() %>
                                    required="required" data-validation-required-message="Please enter your address" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="email" class="form-control border-0 p-4" id="email" name="email" value=<%=s.getEmail() %>
                                    required="required" data-validation-required-message="Please enter your email" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <button type = "submit" class = "btn btn-primary py-3 px-4" name="action" value="update">Update</button> 
                                <p class="help-block text-danger"></p>
                            </div>
