...
%>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Customer's Profile</h1>
            <div class="d-inline-flex align-items-center text-white">
                    ...
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        ...
                        <input type="hidden" name="id" value="<%=c.getId() %>">
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="name" name="name" value=<%=c.getName() %>
                                    required="required" data-validation-required-message="Please enter your name" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="contact" name="contact" value=<%=c.getContact() %>
                                    required="required" data-validation-required-message="Please enter your contact" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="address" name="address" value=<%=c.getAddress() %>
                                    required="required" data-validation-required-message="Please enter your address" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="email" class="form-control border-0 p-4" id="email" name="email" value=<%=c.getEmail() %>
