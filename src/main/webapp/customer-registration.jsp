...
<body>
    ...
    <div class="jumbotron jumbotron-fluid mb-5">
        <div class="container text-center py-5">
            <h1 class="text-white display-3">Customer Registration</h1>
            <div class="d-inline-flex align-items-center text-white">
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-7">
                    <h1 class="text-primary text-uppercase font-weight-bold">Customer Registration</h1>
                    ...
                    <div class="contact-form bg-secondary" style="padding: 30px;">
                        ...
                        <form action="Customer_Controller" method="post">
                            ...
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="contact" name="contact" placeholder="Your Contact"
                                    required="required" data-validation-required-message="Please enter your contact" />
                                <p class="help-block text-danger"></p>
                            </div>
                            <div class="control-group">
                                <input type="text" class="form-control border-0 p-4" id="address" name="address" placeholder="Your Address"
                            ...
                            <div>
                                <button class="btn btn-primary py-3 px-4" type="submit" name="action" value="register" >Register</button>
                            </div>
                        </form>
                    </div>
                </div>
